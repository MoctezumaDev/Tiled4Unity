    ...
    partial class TmxLayer
    {
        public static TmxLayer FromXml(XElement elem, TmxMap tmxMap)
        {
            ...
            else if (elem.Name == "imagelayer")
            {
                ...
                if (xmlImage == null)
                {
                    Console.WriteLine("Image Layer '{0}' is being ignored since it has no image.", tmxLayer.Name);
                ...
                Vector2 translated = tmxLayer.Offset;
                ...
                Vector2 orientation = TmxMath.TileCornerInScreenCoordinates(tmxMap, 0, 0);
        ...
        {
            Console.WriteLine("Parse {0} layer data ...", this.Name);
        ...
        {
            Console.WriteLine("Parsing layer data as Xml elements ...");
        ...
        {
            Console.WriteLine("Parsing layer data as CSV ...");
        ...
        {
            Console.WriteLine("Parsing layer data as base64 string ...");
        ...
        {
            Console.WriteLine("Parsing layer data as base64 gzip-compressed string ...");
            ...
            {
                CopyStream(deflateStream,streamDecompressed);
        ...
        {
            Console.WriteLine("Parsing layer data as base64 zlib-compressed string ...");
            byte[] bytesCompressed = Convert.FromBase64String(elem.Value);
        ...
        private long CopyStream(Stream source, Stream destination)
        {
